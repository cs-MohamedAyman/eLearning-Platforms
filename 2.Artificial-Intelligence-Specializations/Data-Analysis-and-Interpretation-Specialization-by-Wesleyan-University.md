<img align="right" width="100" height="100" src="https://github.com/cs-MohamedAyman/Coursera-Specializations/blob/master/organizations-logos/wesleyan university.jpg">
...
- Software Setup and Supporting Materials
...
- SAS Lessons
  - Video: SAS Lesson 1 - Defining exploratory data analysis
  - Video: SAS Lesson 2 - SAS coding conventions
  - Video: SAS Lesson 3 - Running your program and examining frequency distribution
  - Video: SAS Lesson 4 - Refining your research question by selecting rows
- Python Lessons
  - Video: Python Lesson 1 - Defining Exploratory Data Analysis
  - Video: Python Lesson 2 - Python Coding Conventions
  - Video: Python Lesson 3 - Running your program and examining frequency distributions
  - Video: Python Lesson 4 - Refining your research question by selecting rows
- Assignment: Running Your First Program
  - Peer-graded Assignment: Running Your First Program
  - Grading in progress
  - Review Your Peers: Running Your First Program
...
- Supporting Materials
  - Reading: Graphing Decisions Flowchart
  - Reading: SAS Programs for Video Examples
  - Reading: Python Programs for Video Examples
  - Reading: Codebooks for Video Examples
- SAS Lessons
  - Video: SAS Lesson 1 - Graphing individual variables
  - Video: SAS Lesson 2 - Describing distributions visually
  - Video: SAS Lesson 3 - Measures of center and spread
  - Video: SAS Lesson 4 - Designing the role each of your variables will play
  - Video: SAS Lesson 5 - Graphing decisions: categorical response variables
  - Video: SAS Lesson 6 - Graphing decisions: quantitative response variable
- Python Lessons
  - Video: Python Lesson 1 - Graphing individual variables
  - Video: Python Lesson 2 - Describing distributions visually
  - Video: Python Lesson 3 - Measures of Center and Spread
  - Video: Python Lesson 4 - Designing the role each of your variables will play
  - Video: Python Lesson 5 - Graphing Decisions: Categorical response variables
  - Video: Python Lesson 6 - Graphing decisions: quantitative response variable
- Assignment: Creating Graphs for Your Data
  ...
  - Review Your Peers: Creating graphs for your data
  - Reading: Assignment Sample
- More Supporting Materials - All Weeks
  - Reading: How to Write a Literature Review
  - Reading: Translation Code
...
- Ideas behind the Chi Square test of independence
  - Video: Lesson 1 - Ideas behind the Chi Square test of independence
- SAS Lectures
  - Reading: SAS Program Code for Video Examples
  - Video: SAS Lesson 2 - Chi Square Test of independence in practice
  - Video: SAS Lesson 3 - Post hoc tests for Chi Square tests of independence
  - Video: SAS Lesson 4 - Chi Square summary
- Python Lectures
  - Reading: Python Program Code for Video Examples
  - Video: Python Lesson 2 - Chi Square test of independence in practice
  - Video: Python Lesson 3 - Post hoc tests for Chi Square tests of independence
  - Video: Python Lesson 4 - Chi Square summary
- Assignment
  - Reading: Example: Running a Chi-Square Test of Independence
  - Peer-graded Assignment: Running a Chi-Square Test of Independence
  - Review Your Peers: Running a Chi-Square Test of Independence
</details>
...
- SAS Lessons
  - Reading: SAS Program Code for Video Examples
  - Video: SAS Lesson 1 - Defining moderation, a.k.a. statistical interaction
  - Video: SAS Lesson 2 - Testing moderation in the context of ANOVA
  - Video: SAS Lesson 3 - Testing moderation in the context of chi square
  - Video: SAS Lesson 4 - Testing moderation in the context of correlation
- Python Lessons
  - Video: Python Lesson 1 - Defining moderation, a.k.a. statistical interaction
  - Video: Python Lesson 2 - Testing moderation in the context of ANOVA
  - Video: Python Lesson 3 - Testing moderation in the context of Chi-Square
  - Video: Python Lesson 4 - Testing moderation in the context of correlation
  - Reading: Python Program Code for Video Examples
- But do my findings tell me anything about Causation?
  - Video: A Question of Causation (Used with Permission from Annenberg Learner)
  - Peer-graded Assignment: Testing a Potential Moderator
  - Grading in progress
  - Review Your Peers: Testing a Potential Moderator
</details>
...
- SAS Lessons
  - Reading: SAS Program Code for Video Examples
  - Video: SAS Lesson 1: More on Confounding Variables
  - Video: SAS Lesson 2: Testing a Basic Linear Regression Mode
  - Video: SAS Lesson 3: Categorical Explanatory Variables
- Python Lessons
  - Reading: Python Program Code for Video Examples
  - Video: Python Lesson 1: More on Confounding Variables
  - Video: Python Lesson 2: Testing a Basic Linear Regression Model
  - Video: Python Lesson 3: Categorical Explanatory Variables
- Linear Regression Assumptions
  - Video: Lesson 4: Linear Regression Assumptions
  - Reading: Outlier Decision Tree
- Centering Explanatory Variables
  - Video: Lesson 5: Centering Explanatory Variables
- Assignment
  - Peer-graded Assignment: Test a Basic Linear Regression Model
  - Grading in progress
  - Review Your Peers: Test a Basic Linear Regression Model
</details>
...
- SAS Lesson
  - Reading: SAS Program Code for Video Examples
  - Video: SAS Lesson 1: Categorical Explanatory Variables with More Than Two Categories
- Python Lesson
  - Reading: Python Program Code for Video Examples
  - Video: Python Lesson 1: Categorical Explanatory Variables with More Than Two Categories
- A Few Things to Keep in Mind
  - Video: Lesson 2: A Few Things to Keep in Mind
- SAS Videos
  - Video: SAS Lesson 3: Logistic Regression for a Binary Response Variable, pt 1
  - Video: SAS Lesson 4: Logistic Regression for a Binary Response Variable, pt. 2
- Python Videos
  - Video: Python Lesson 3: Logistic Regression for a Binary Response Variable, pt. 1
  - Video: Python Lesson 4: Logistic Regression for a Binary Response Variable, pt. 2
- Assignment
  - Peer-graded Assignment: Test a Logistic Regression Model
  - Grading in progress
  - Review Your Peers: Test a Logistic Regression Model
- Video credits
  - Reading: Week 1 Video Credits
  - Reading: Week 2 Video Credits
  - Reading: Week 3 Video Credits
  - Reading: Week 4 Video Credits
</details>
...
- What is a Random Forest and How Is It 'Grown'?
  - Video: What Is A Random Forest and How Is It "Grown"?
- Building a Random Forest with SAS
  - Reading: SAS code: Random Forests
  - Reading: The HPForest Procedure in SAS
  - Video: Building a Random Forest with SAS
- Building a Random Forest with Python
  - Reading: Python Code: Random Forests
  - Video: Building a Random Forest with Python
- Validation and Cross-Validation
  - Video: Validation and Cross-Validation
- Assignment
  - Peer-graded Assignment: Running a Random Forest
  - Grading in progress
  - Review Your Peers: Running a Random Forest
  - Reading: Assignment Example
</details>
...
- What Is a k-Means Cluster Analysis?
  - Video: What Is a k-Means Cluster Analysis?
  - Running a k-Means Cluster Analysis in SAS
  - Video: Running a k-Means Cluster Analysis in SAS, pt. 1
  - Video: Running a k-Means Cluster Analysis in SAS, pt. 2
  - Reading: SAS Code: k-Means Cluster Analysis
  - Running a k-Means Cluster Analysis in Python
  - Reading: Python Code: k-Means Cluster Analysis
  - Video: Running a k-Means Cluster Analysis in Python, pt. 1
  - Video: Running a k-Means Cluster Analysis in Python, pt. 2
- k-Means Cluster Analysis Limitations
  - Video: k-Means Cluster Analysis Limitations
- Assignment
  - Peer-graded Assignment: Running a k-means Cluster Analysis
  - Grading in progress
  - Review Your Peers: Running a k-means Cluster Analysis
  - Reading: Assignment Example
</details>
