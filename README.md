...
**SKILLS YOU WILL GAIN:**<br>
`digital signal processing`, `image restoration`, `neurology`, `time series forecasting`, `technology disruption`, `workflow of machine learning projects`, `programming language`, `image compression`, `neurological disorders`, `ai strategy`, `problem solving`, `data compression`, `process mining`, `financial data analysis`, `financial analysis`, `process modeling`, `ai terminology`, `digital strategy`, `time series models`, `neurobiology`, `reinforcement learning trading algo development`, `decision support system`, `analytics`, `cloud computing`, `algorithmic trading`, `transformation matrix`, `matplotlib`, `forecasting`, `statistical model`, `function approximation`, `vector calculus`, `image segmentation`, `collaborative filtering`, `exploratory data analysis`, `natural language processing`, `gradient descent`, `principal component analysis (pca)`, `model evaluation`, `hyperparameter optimization`, `mathematical optimization`, `investment management knowledge`, `statistical analysis`, `multi-task learning`, `data management`, `hyperparameter`, `advanced machine learning`, `project management`, `model tuning`, `summary statistics`, `advanced deployment`, `programming skills`, `microsoft excel`, `evaluation`, `advanced vizualisation`, `statistical regression`, `tensorflow serving`, `statistical inference methods`, `applied machine learning`, `matrix factorization`, `federated learning`, `treatment effect estimation`, `analysis of variance (anova)`, `time series`, `scikit-learn`, `lasso (statistics)`, `dimensionality reduction`, `confidence interval`, `backpropagation`, `reinforcement learning`, `tensorflow lite`, `facial recognition system`, `sas language`, `financial engineering`, `intelligent systems`, `random forest`, `tokenization`, `model interpretation`, `predictive modelling`, `q-learning using financial problems`, `decision tree`, `machine learning interpretation`, `python libraries`, `data processing`, `natural language toolkit (nltk)`, `computer vision`, `google cloud platform`, `eigenvalues and eigenvectors`, `chi-squared (chi-2) distribution`, `ridge regression`, `rnns`, `cnns`, `image processing`, `object detection`, `tensorflow.js`, `augmentation`, `bayesian statistics`, `multi-class classification`, `markov chain monte carlo (mcmc)`, `matlab`, `estimator`, `regression analysis`, `keras`, `watson ai`, `recurrent neural network`, `feature extraction`, `logistic regression`, `document retrieval`, `apache spark`, `inductive transfer`, `data clustering algorithms`, `predictive analytics`, `data mining`, `classification algorithms`, `statistical hypothesis testing`, `linear algebra`, `information retrieval (ir)`, `variational bayesian methods`, `probabilistic models`, `linear regression`, `portfolio optimization`, `bayesian optimization`, `gaussian process`, `artifical intelligence`, `statistics`, `data cleansing`, `convolutional neural network`, `numpy`, `data science`, `application programming interfaces (api)`, `feature engineering`, `data virtualization`, `data analysis`, `deep learning`, `tensorflow`, `artificial neural network`, `pandas`, `data visualization (dataviz)`, `text mining`, `machine learning`, `recommender systems`
...
**SKILLS YOU WILL GAIN:**<br>
`android`, `angularjs`, `express.js`, `sql`, `product development`, `network architecture`, `google app engine (gae)`, `websites`, `concurrency (computer science)`, `document object model (dom)`, `engineering projects`, `relational database`, `dataflow`, `unity (user interface)`, `concurrent computing`, `web application development`, `entrepreneurship`, `design thinking`, `planning`, `unit testing`, `textures`, `style sheets`, `wordpress`, `d computer graphics`, `sensors`, `persistence`, `software development lifecycle (sdlc)`, `parallel computing`, `data parallelism`, `junit`, `ionic (mobile app framework)`, `video game design`, `shell script`, `data structure`, `web service`, `kubernetes`, `android (operating system) software`, `new product development`, `android app development`, `react (javascript library)`, `treejack`, `website wireframe`, `video game development`, `game design`, `optimistic concurrency control`, `string (computer science)`, `typescript`, `actor model`, `game design document`, `kanban`, `virtual machine`, `vr`, `core data`, `hypertext preprocessor (php)`, `mysql`, `agile user stories`, `object-oriented analysis and design`, `adobe indesign`, `marketing communications`, `software quality`, `graphic design`, `microservices`, `user interface techniques`, `risk management`, `phpmyadmin`, `strategy`, `lean startup`, `bash (unix shell)`, `web accessibility`, `software design pattern`, `d computer graphics`, `security software`, `engineering management`, `jenkins (software)`, `c sharp (c#) (programming language)`, `create, read, update and delete`, `object-oriented design`, `interaction technique`, `major projects`, `adobe xd`, `virtual reality`, `interactive control`, `database (db) design`, `github`, `opengl++`, `hypothesis-driven development`, `unified modeling language (uml)`, `bitbucket`, `application security`, `command-line interface`, `version control`, `usability testing`, `apache cordova`, `software development`, `redux`, `service-oriented architecture`, `java`, `mobile application development`, `software development kit (sdk)`, `cryptography`, `marvel`, `graphs`, `web design`, `swift (programming language)`, `programming principles`, `objective-c`, `node.js`, `html`, `google cloud platform`, `google compute engine`, `software product management`, `using version control`, `testing in python`, `authentication`, `a/b testing`, `cloud applications`, `html/css`, `scrum (software development)`, `human–computer interaction`, `heuristic evaluation`, `continuous delivery`, `project management`, `apis`, `nosql`, `cloud infrastructure`, `reactive programming`, `persona (user experience)`, `regular expression (regex)`, `rapid prototyping`, `algorithms`, `android software development`, `storyboarding`, `automation`, `routing`, `distributed algorithm`, `software requirements`, `software project management`, `cloud storage`, `paper prototyping`, `user interface design (ui design)`, `ios app development`, `python programming`, `software testing`, `basic python syntax`, `lean software development`, `sass (stylesheet language)`, `xcode`, `machine learning`, `big data`, `troubleshooting & debugging`, `logic programming`, `software architecture`, `distributed computing`, `software-defined networking`, `software design`, `fundamental programming concepts`, `configuration management`, `user story`, `bootstrap (front-end framework)`, `jquery`, `android studio`, `user interface`, `software development process`, `mongodb`, `agile software development`, `javascript`, `java programming`, `user experience (ux)`, `responsive web design`, `agile`, `product management`, `user experience design (uxd)`, `user research`, `web development`, `cloud computing`
