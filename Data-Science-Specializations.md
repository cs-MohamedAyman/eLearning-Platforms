...
`business intelligence`, `log–log plot`, `exploratory data analysis`, `statistics`, `arrays`, `storyboarding`, `sas language`, `mapreduce`, `cloudera`, `xml`, `artificial intelligence (ai)`, `formulate a scientific hypothesis`, `presentation`, `basic programming language`, `google cloud platform`, `sql`, `internet of things (iot)`, `statistical inference methods`, `big data products`, `interpretation`, `correlation and dependence`, `array programming`, `microsoft excel`, `mysql`, `normal distribution`, `machine learning concepts`, `data visualization (dataviz)`, `data pre-processing`, `relational algebra`, `big data`, `generalized linear model`, `materialized view`, `communication`, `graphs`, `natural language toolkit (nltk)`, `data science`, `statistical thinking`, `financial analysis`, `data processing`, `database (db) design`, `regular expression (regex)`, `data parallelism`, `deep learning`, `run and interpret kaplan-meier curves in r`, `chi-squared (chi-2) distribution`, `microsoft excel macro`, `business analysis`, `statistical hypothesis testing`, `bayesian linear regression`, `reactive programming`, `extraction, transformation and loading (etl)`, `cloud databases`, `linear regression`, `microsoft excel vba`, `entity`, `cluster analysis`, `presentation skills`, `logistic regression`, `pentaho`, `simulation`, `survival analysis`, `recursion`, `apache hadoop`, `machine learning`, `tensorflow`, `pandas`, `business analytics`, `regression analysis`, `random forest`, `bigquery`, `predictive modelling`, `query string`, `visualization (computer graphics)`, `financial data analysis`, `statistical model`, `scikit-learn`, `python programming`, `json`, `interactive visualization`, `entity–relationship (e-r) model`, `data integration`, `machine learning (ml) algorithms`, `apache spark`, `scala programming`, `data analysis`, `functional programming`, `splunk`, `business process`, `leadership`, `mathematical optimization`, `statistical analysis`, `data modeling`, `matplotlib`, `relational database management system (rdbms)`, `neo4j`, `sqlite`, `streams`, `cloud computing`, `tableau software`, `long short-term memory (istm)`, `information engineering`, `poisson distribution`, `expected return`, `data analysis with r`, `map`, `nosql`, `numpy`, `rstudio`, `understand common ways to choose what predictors go into a regression model`, `problem solving`, `bayesian statistics`, `team management`, `visual analytics`, `data-informed decision-making`, `statistical regression`, `sap hana`, `python libraries`, `analysis of variance (anova)`, `team building`, `pivot chart`, `r programming`, `management`, `data manipulation`, `text mining`, `run basic analyses in r`, `dashboard (business)`, `functional design`, `python syntax and semantics`, `data structure`, `data model`, `ipython`, `consolization`, `data virtualization`, `bayesian inference`, `model selection`, `concatenation`, `spreadsheet`, `a/b testing`, `database (dbms)`, `data warehouse`, `mongodb`, `pivot table`, `data quality`, `data management`, `data warehousing`, `parallel algorithm`, `creating metrics`, `lookup table`, `parallel computing`, `relational database`, `recommender systems`, `computer programming`, `project`, `predictive analytics`, `binary classification`, `data wrangling`, `github`, `confidence interval`, `understand common data distributions and types of variables`, `tuple`, `data validation`, `chart`, `web scraping`, `statistical inference`, `presentation design`, `interaction (statistics)`, `debugging`, `data cleansing`
